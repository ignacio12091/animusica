			...
			if (!this.state.errorFetchingPlaylists) {
				if (this.state.playlists) {
					...
					this.state.playlists.forEach(item => {
						result.push(
							<button key={item.id} className="song" style={{ display: 'flex', width: '100%', flexDirection: 'row', backgroundColor: 'rgb(30,30,30)', borderRadius: 5, alignItems: 'center', marginBottom: '2.5%', marginTop: '2.5%', height: '30vh' }} onClick={() => {  }}>
